...
async def test():
    ...
    # Try with raw photo id and photo base64 id
    raw_id = "1532133465628571"
    import base64
    b64_photo = base64.b64encode(f"feedback:{raw_id}".encode()).decode()
    b64_photo2 = base64.b64encode(raw_id.encode()).decode()
    
    ids_to_try = [raw_id, b64_photo, b64_photo2]
    ...
    async with httpx.AsyncClient(cookies=cookies) as client:
        for tid in ids_to_try:
            ...
            payload = {
                ...
                "__a": "1",
                "doc_id": "25550760954572974", # CommentsListComponentsPaginationQuery
            ...
            try:
                ...
                print(f"ID {tid} -> {len(edges)} edges found.")
            except Exception as e:
                print(f"ID {tid} failed: {e}")
